...
fs.mkdirSync(`4-5/output/${process.argv[2]}`, { recursive: true });
fs.writeFileSync(`4-5/output/${process.argv[2]}/hotel.txt`, hotelOutput, "utf-8");
for (let i = 0; i < visitorsOutput.length; i++) fs.writeFileSync(`4-5/output/${process.argv[2]}/visitor-${i}.txt`, visitorsOutput[i], "utf-8");